                                        ...
                                        <c:forEach  items="${comments}" var="item" >
                                         ...
                                         ${comment.userId}&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<script>document.write(new Date(${comment.createTime}).toLocaleString())</script>
                                                ...
                                                <tr class="panel-footer">
                                                    ...
                                                    <c:if test="${item.size()<2}" var="<string>" >
                                                        <td><button type="button" class="btn btn-default" id="addComment"
                                                                 onclick="answer(${comment.id})"   data-toggle="modal" data-target="#myModal2">答疑</button></td>
                                                    </c:if>
                                                    <c:if test="${item.size()==2&&idx.index==0}" var="<string>" >
                                                        <td><a>已解答</a></td>
                                                    </c:if>
                                                </tr>
                                            </c:forEach>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="height: 350px;width: 600px">
            <div class="modal-body">
                <form onsubmit="return check2()" method="post" action="/teacher/add" enctype="multipart/form-data">
